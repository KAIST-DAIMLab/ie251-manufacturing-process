...
def _install_ros_stubs():
    ...
    pathfinding_system_msg.MoveToNodeAction = MoveToNodeAction
    pathfinding_system_msg.MoveToNodeGoal = MoveToNodeGoal
    pathfinding_system_msg.RobotCommandAction = RobotCommandAction
    pathfinding_system_msg.RobotCommandGoal = RobotCommandGoal
